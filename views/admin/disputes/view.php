...
?>
<h1><?=$this->getTrans('resolveDispute') ?> #<?=$this->escape((string)$dispute['id']) ?></h1>
<p><strong><?=$this->getTrans('match') ?>:</strong> #<?=$this->escape((string)$match['id']) ?> (<?=$this->getTrans('round') ?> <?=$this->escape((string)$match['round']) ?> / <?=$this->getTrans('match') ?> <?=$this->escape((string)$match['match_no']) ?>)</p>
...
<?php if ($reports): ?>
    <?php foreach ($reports as $report): ?>
        <div class="card mb-2 rounded-0">
            <div class="card-body">
                <p class="mb-1"><?=$this->getTrans('score') ?>: <?=$this->escape((string)$report['score1']) ?> : <?=$this->escape((string)$report['score2']) ?></p>
