...
use Modules\Ladder\Mappers\MemberProfileMapper;
...
class Members extends \Ilch\Controller\Frontend
{
    public function viewAction()
    {
        ...
        $team = $participantMapper->getById((int)$member['participant_id']);
        if (!$team) {
            $this->redirect()->to(['module' => 'ladder', 'controller' => 'ladders', 'action' => 'index']);
        }
        ...
        $this->getLayout()->getHmenu()
            ...
            ->add($this->getTranslator()->trans('teams'), ['module' => 'ladder', 'controller' => 'teams', 'action' => 'view', 'id' => (int)$team['id']])
    ...
    public function editAction()
    {
        ...
        $this->getLayout()->getHmenu()
            ->add($this->getTranslator()->trans('menuLadder'), ['module' => 'ladder', 'controller' => 'ladders', 'action' => 'index'])
            ->add($team['team_name'], ['module' => 'ladder', 'controller' => 'teams', 'action' => 'view', 'id' => (int)$team['id']])
